// npx playwright test tests/examples/Authentication/admin.spec.js --trace on --headed
// npx playwright test tests/examples/Authentication/ --headed

import { expect, test } from '@playwright/test';

// This test will log in seamlessly using 'error_user' (Admin) cookies
test('Admin User Checkout Flow', async ({ page }) => {
